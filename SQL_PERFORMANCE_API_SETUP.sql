-- ============================================
-- SQL Script: Setup Performance API Tables
-- ============================================
-- This script creates tables for storing Business Profile Performance API data
...
BEGIN
  IF NOT EXISTS (
    ...
    AND tablename = 'gmb_performance_metrics' 
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_performance_metrics' 
    AND policyname = 'Users can insert their own performance metrics'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_performance_metrics' 
    AND policyname = 'Users can update their own performance metrics'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_performance_metrics' 
    AND policyname = 'Users can delete their own performance metrics'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_search_keywords' 
    AND policyname = 'Users can view their own search keywords'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_search_keywords' 
    AND policyname = 'Users can insert their own search keywords'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_search_keywords' 
    AND policyname = 'Users can update their own search keywords'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'gmb_search_keywords' 
    AND policyname = 'Users can delete their own search keywords'
  ) THEN
...
SELECT 
  'gmb_performance_metrics table created' AS status,
  EXISTS (
    SELECT 1 FROM information_schema.tables 
    WHERE table_schema = 'public' 
    AND table_name = 'gmb_performance_metrics'
  ) AS table_exists;

SELECT 
  'gmb_search_keywords table created' AS status,
  EXISTS (
    SELECT 1 FROM information_schema.tables 
    WHERE table_schema = 'public' 
    AND table_name = 'gmb_search_keywords'
  ) AS table_exists;
